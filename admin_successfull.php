...
li{
	...
	<div id="fh5co-counter" class="fh5co-counters">
        ...
        <img src="project images\text-slogan.png" width="580px" height="180px"></center>
			<div class="row">
				<div class="col-md-4 text-center animate-box">
                <img src="project images\l.png" alt="text" height="150px">   
                <a href="lectreg.php"><h3>Add Lecturer</h3></a>
                  
                 
				</div>
                <div class="col-md-4 text-center animate-box">
                <img src="project images\ediiiit45.png" alt="text" height="150px">   
                <a href="admin_successfull1.php"><h3>View profile</h3></a>
                 
				</div>
                <div class="col-md-4 text-center animate-box">
                    
                <img src="project images\ediiti445.png" alt="text" height="150px">
                <a href='admin_successfull2.php'><h3>Edit  profile</h3></a>
