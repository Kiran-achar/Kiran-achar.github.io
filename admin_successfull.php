        ...
        <h2>Its All About You!!!</h2>
			<div class="row">
				<div class="col-md-4 text-center animate-box">
                 <a href="lectreg.php"><img src="project images\l.png" alt="text" height="150px">  </a> 
               <h3>Add Lecturer</h3>
                  
                 
				</div>
                <div class="col-md-4 text-center animate-box">
                 <a href="admin_successfull1.php"><img src="project images\ediiiit45.png" alt="text" height="150px">  </a> 
               <h3>View profile</h3>
                 
				</div>
                <div class="col-md-4 text-center animate-box">
                    
                     <a href='admin_successfull2.php'><img src="project images\ediiti445.png" alt="text" height="150px"></a>
           <h3>Edit  profile</h3>
