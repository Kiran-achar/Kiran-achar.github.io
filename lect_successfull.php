...
<br>Note That:You May Upload Any Formated File,Your File Size Should less than 100mb
                ...
                <div class="col-md-6 text-center animate-box">
                <h3 align="center">Please select your sem to upload notes<br><br>
                    <form method='post' action='upload9.php' enctype='multipart/form-data'>&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="row">
...
</table><br><input type='submit' value='Upload!' class='upp'>
<img src='project images/9.gif'></form>
