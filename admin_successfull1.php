...
<div id="fh5co-counter" class="fh5co-counters" style="margin-top:-20px;">
		<div class="container">
        <a href="admin_successfull.php">Back</a><center>
		<img src="project images/choose.gif" width="40%" style="margin-top:-40px;">
       
			<div class="row">
				<div class="col-md-4 text-center animate-box">
                    <a href="lectureDetails.php"><img src="project images\vld.png" alt="text" height="150px"> </a>  
              <h3>View Lecturer Details</h3>
                  
                </div>
                <div class="col-md-4 text-center animate-box">
                   <a href="studentDetails1.php"><img src="project images\vsd.png" alt="text" height="150px"> </a>  
             <h3>View Students Details</h3>
                 
				</div>
                <div class="col-md-4 text-center animate-box">
                    
                 <a href="notesDetails.php"><img src="project images\vund.png" alt="text" height="150px"></a>
               <h3>View Uploaded Notes Details</h3>
                     
                </div>
            </div>
			<div class="row">
				<div class="col-md-12 text-center animate-box">
                <img src="project images\adminn.png" alt="text" width="60%">   
