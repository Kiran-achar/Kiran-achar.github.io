...
li{
	...
	<div id="fh5co-counter" class="fh5co-counters" style="margin-top:-30px">
		<div class="container">
        <a href="admin_successfull1.php">Back</a><center>
...
$sql = "Select first_name,father,address,gender,contact,username,password,id from student";
...
echo"<h2 style='margin-left:100px;'>These are the student Registration Available!!</h2>";
echo"<div style='overflow-x:auto;'>";
echo"<table border=1 padding=10 align='center'><tr height='40px'><td align='center'><b>Name</b></td><td align='center'><b>Father Name</b></td>
  ...
  while ($row = mysqli_fetch_row($result)) {
   ...
   echo "<tr>";
  	echo "<td align='center'>$row[0]</td>";
   	...
   	echo "<input type='hidden' value='$row[7]' name='hiddenId'>";
    echo "<td align='center'><a href='delete1.php?hiddenId=$row[7]'><img src='project images/d.png' width='30px'  height='30px' onclick='return del();'></a></td></tr>";
...
echo"</table></div>";
   ...
   echo"<center><img src='project images/nofn.png' width='60%'></center>";
...
<script type="text/javascript">
	function del(){
		if(confirm('Are You Sure Want To Delete This Record From Database!!!')){
			return true;
		}
		else{
			return false;
