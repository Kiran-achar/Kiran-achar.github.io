...
echo"<h2 style='margin-left:100px;'>These are the Lectrer Registration Available!!</h2>";
echo"<div style='overflow-x:auto;'><table border=1 padding=10 align='center'><tr height='40px'><td align='center'><b>Lecturer Photo</b></td><td align='center'><b>Name</b></td><td align='center'><b>Qualification</b></td>
<td align='center'><b>Gender</b></td>
<td align='center'><b>Contact</b></td><td align='center'><b>Username</b></td>
...
<td align='center'><b>Delete</b></td>
  ...
  while ($row = mysqli_fetch_row($result)) {
   ...
   $i++;
   echo "<tr><td align='center'><img src='uploads/$row[0]' width='200px' height='200px'></td>";
  	echo "<td align='center'>$row[3]</td>";
   	...
   	echo "<input type='hidden' value='$row[10]' name='hiddenId'>";
    echo "<td align='center'><a href='delete.php?hiddenId=$row[10]'><img src='project images/d.png' width='30px'  height='30px' onclick='return del();'></a></td></tr>";
...
echo"</table></div>";
    ...
    print"<center><img src='project images/nofo.png' width='60%'></center>";
