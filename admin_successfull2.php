...
$i=0;
  ...
  $i++;
	//echo"<br><br><br><h2 style='margin-left:100px;'>Update Here!!</h2>";
echo"<center><img src='project images\update.gif' width='400px' height='200px'>";

echo"<form method='post' action='update1.php'>";
echo"<br><table >
<tr>
	<th>username</th><td><input type='text' value='$row[0]' name='a'></td></tr>
	<tr>
	<th>password</th><td><input type='text' value='$row[1]' name='b'></td>
	</tr>
</table><br>
<input type='submit' value='update' style='margin-left:150px;'>
